...
describe("Run tests", function() {
    describe("P1 King move validation", function () {
        describe("Checks for valid moves", function () {

            it("should return true for p1 valid move 5,5 to 4,4 (forward left)", function () {
                var move = {"old_pos": {"row": 5, "col": 5}, "new_pos": {"row": 4, "col": 4}};
                expect(is_valid_move(move, king_board)).toBe(true);
            });

            it("should return true for p1 valid move 6,6 to 7,7 (backward right)", function () {
                var move = {"old_pos": {"row": 6, "col": 6}, "new_pos": {"row": 7, "col": 7}};
                expect(is_valid_move(move, king_board)).toBe(true);
            });

            it("should return true for p1 valid move 5,5 to 4,6 (forward right)", function () {
                var move = {"old_pos": {"row": 5, "col": 5}, "new_pos": {"row": 4, "col": 6}};
                expect(is_valid_move(move, king_board)).toBe(true);
            });

            it("should return true for p1 valid king move 5,5 to 6,4 (backward left)", function () {
            ...
            it("should return false for p1 invalid move 6,6 to 5,5 (slot occupied)", function () {
                var move = {"old_pos": {"row": 5, "col": 5}, "new_pos": {"row": 6, "col": 6}};
                expect(is_valid_move(move, king_board)).toBe(false);
            });
    ...
    describe("P2 King move validation", function () {
        describe("Checks for valid p2 moves", function () {
            ...
            it("should return true for p2 valid king move 2,4 to 1,5 ", function () {
                var move = {"old_pos": {"row": 2, "col": 4}, "new_pos": {"row": 1, "col": 5}};
                expect(is_valid_move(move, king_board)).toBe(true);
            });

            it("should return true for p2 valid king move 2,4 to 1,3 ", function () {
                var move = {"old_pos": {"row": 2, "col": 4}, "new_pos": {"row": 1, "col": 3}};
                expect(is_valid_move(move, king_board)).toBe(true);
            });
